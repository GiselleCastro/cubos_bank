...
export class CardsRepository {
  ...
  async findByAccountIdAndAccountNumber(accountId: string, accountNumber: string): Promise<Cards | null> {
    return this.prisma.cards.findUnique({ where: { id: accountId, number: accountNumber } });
  }
