...
import { CheckBalanceUseCaseFactory } from '../../use-cases/factories/checkBalance'
...
export class AccountsControllerFactory {
  static make(): AccountsController {
    ...
    return new AccountsController(createAccount, listOfAccounts, createCard, checkBalance)
  }
}
